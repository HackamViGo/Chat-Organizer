...
|----------|-------------|
| `docs/DASHBOARD.md` | Аналогично на `EXTENSION.md`, описващо Route Guards, UI State и Store logic. |
| `docs/DEPLOYMENT.md` | Актуален гид за Vercel + Supabase Migrations. |
| `docs/TESTING.md` | Описва Vitest интеграцията в Dashboard и Extension. |
