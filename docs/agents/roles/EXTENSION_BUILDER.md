...
- **Primary Source:** [.agent/rules/ProjectGraph.json](file:///home/stefanov/Projects/Chat Organizer Cursor/.agent/rules/ProjectGraph.json) (Search for `EXTENSION` and `PROMPT` nodes).
- **Knowledge Source:** [docs/Mandatory!/PROMPTS.md](file:///home/stefanov/Projects/Chat Organizer Cursor/docs/Mandatory!/PROMPTS.md).

---

## 🛠️ MCP TOOLBOX
- **Config Path:** [/home/stefanov/.cursor/mcp.json](file:///home/stefanov/.cursor/mcp.json).
- **Mandatory MCP:** `chrome-devtools`, `mcp-context7`.
...
1. **Context Check:** Use `mcp-context7` for latest Chrome API and Prompting standards.
