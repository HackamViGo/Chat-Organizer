...
### ❌ Images Feature (ПРЕМАХНАТО)
- ❌ **Images раздел** - Скрит от навигацията
- ❌ **Image Folders** - Недостъпни
- ❌ **Right-click Save** - Премахнато от разширението
- ❌ **AVIF Conversion** - Не се поддържа

### ✅ Extension Prompts (v2.0.2)
- ✅ **Inject Prompt** - Вмъкване в Gemini/ChatGPT/Claude (чрез context menu и бутон)
- ✅ **Prompts Popup** - Меню в самия сайт за избор на промпт
- ✅ **Selected Text to Prompt** - Създаване на нов промпт от маркиран текст
